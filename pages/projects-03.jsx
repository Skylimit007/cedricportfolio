        ...
        <Div className="container">
          ...
          <Div className="row">
            <Div className="col-lg-6">
              <SectionHeading title="Headlight heros" subtitle="Creative">
                <Spacing lg="40" md="20" />
                <p>
                The young and enthusiast CEO of headlight heroes wanted to remodell their website to a more modern and comfortable look. He asked for it and my team and I delivered perfection 👌.
                </p>
                <Spacing lg="10" md="10" />
               {/*  <p>
            ...
            <Div className="col-lg-5 offset-lg-1">
              ...
              <Div className="row">
                ...
                <Div className="col-6">
                  ...
                  <p className="cs-m0"> Nairobi, industrial area. </p>
                  <Spacing lg="30" md="30" />
                </Div>
                {/* <Div className="col-6">
                  <h3 className="cs-accent_color cs-font_22 cs-font_18_sm cs-m0">
